...
import { Code2, Palette, Database, Globe, Smartphone, Search } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Complete MERN stack applications with modern UI/UX, RESTful APIs, and database integration.",
      features: ["React.js Frontend", "Node.js Backend", "MongoDB Database", "Express.js APIs"],
      price: "Starting at $500"
    },
    {
      icon: <Globe className="text-accent" size={32} />,
      title: "Frontend Development",
      description: "Responsive and interactive user interfaces using React, TypeScript, and modern CSS frameworks.",
      features: ["React Applications", "Responsive Design", "Performance Optimization", "Cross-browser Support"],
      price: "Starting at $300"
    },
    {
      icon: <Smartphone className="text-primary-glow" size={32} />,
      title: "Backend Development",
      description: "Robust server-side solutions with secure authentication, data management, and API development.",
      features: ["RESTful APIs", "Database Design", "Authentication", "Server Deployment"],
      price: "Starting at $400"
    },
    {
      icon: <Palette className="text-primary" size={32} />,
      title: "UI/UX Design & Photoshop",
      description: "Creative design solutions, photo manipulation, and visual content creation for your brand.",
      features: ["Logo Design", "Photo Editing", "UI Mockups", "Brand Identity"],
      price: "Starting at $150"
    },
    {
      icon: <Database className="text-accent" size={32} />,
      title: "Data Entry Services",
      description: "Accurate and efficient data entry with quick turnaround times and attention to detail.",
      features: ["Data Processing", "Excel/Spreadsheets", "Web Research", "Quality Assurance"],
    ...
    },
    {
      ...
      features: ["Bug Fixes", "Performance Updates", "Security Patches", "Content Updates"],
