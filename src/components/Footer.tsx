      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-muted-foreground">rpremkumar324@gmail.com</p>
              <p className="text-muted-foreground">+91 8688645767</p>
              <p className="text-muted-foreground">Kakinada, India</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-muted-foreground text-sm flex items-center">
              ...
              <Heart className="text-red-500 mx-1" size={16} /> by Prem Kumar
            </p>
